...
MYSQL_PWD=root@123 mysql -uroot  -N -s  unica_dashbrd -e "update $table set alert=1 where period='$period' and workflow_name='$workflow_name'" && echo "<center><h2>Alert Enabled for $workflow_name in ${2}_${period}</h></center>" 


else echo -e "<center><h2>Wrong Argument</h></center>" ; fi
